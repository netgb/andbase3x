...
import com.andbase.library.view.listener.AbOnScrollYListener;
...
public class AbScrollListView extends ListView {
    ...
    private AbOnScrollYListener onScrollListener;
     ...
     */
    public void setOnScrollListener(AbOnScrollYListener onScrollListener) {
