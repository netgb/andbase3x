...
public class AbFooterView extends LinearLayout {
    ...
    /** 文字 */
    public static String[] loadMessages = new String[]{"加载更多","正在加载...","加载完成","没有了","加载失败"};
    ...
    public void setLoadingView(View view) {
        if(view == null){
            int borderColor = AbColorUtil.getAttrColor(context,R.attr.colorPrimary);
            int waveColor = AbColorUtil.getAttrColor(context,R.attr.colorPrimary);
            int borderWidth = 1;
    ...
    public static String[] getLoadMessages() {
        return loadMessages;
    }

    public static void setLoadMessages(String[] loadMessages) {
        AbFooterView.loadMessages = loadMessages;
    }
}
